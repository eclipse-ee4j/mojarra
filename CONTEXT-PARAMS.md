...
<tr><td><code>int</code></td><td><code>2</code></td><td>2.0</td><td>request</td><td>Amount of seconds between two checks whether a compiled view has been modified on disk. <code>-1</code> is the fastest as it drops the check altogether and compiles every view only once, which the runtime already applies by itself when the project stage is <code>Production</code>.</td></tr>
...
<tr><td><code>boolean</code></td><td><code>true</code></td><td>1.2_15</td><td>-</td><td>Renders <code>autocomplete="off"</code> on the hidden view state field, so that the browser does not restore a stale state on a back navigation.</td></tr>
