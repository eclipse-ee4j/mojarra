    ...
    Element faces_configElement = toPopulate.getDocumentElement();
     {
      Element factoryElement = toPopulate.createElementNS(ns, "factory");
      ...
      }
       {
        ...
        view_declaration_language_factoryElement.appendChild(toPopulate.createTextNode("com.sun.faces.application.view.ViewDeclarationLanguageFactoryImpl"));
      ...
      }
       {
        ...
        search_expression_context_factoryElement.appendChild(toPopulate.createTextNode("com.sun.faces.component.search.SearchExpressionContextFactoryImpl"));
